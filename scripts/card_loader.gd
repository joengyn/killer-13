...
func load_sprites():
	...
	# Map Card enum values to column indices
	# Rank enum: THREE=0, FOUR=1, FIVE=2, ..., QUEEN=10, KING=11, ACE=11, TWO=12
	# We need: 3=col3, 4=col4, 5=col5, 6=col6, 7=col7, 8=col8, 9=col9, 10=col10, J=col11, Q=col12, K=col13, A=col1, 2=col2
	var rank_to_col = [
